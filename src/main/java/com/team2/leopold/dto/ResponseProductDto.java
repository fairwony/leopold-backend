...
public class ResponseProductDto {
    ...
    public ResponseProductDto(Integer uid, String coverUrl, String detailUrl, LocalDateTime date, Integer price, Double discountRate, String soldOutYn, String color, String engraving, String switchValue, String productCategory) {
        this.uid = uid;
