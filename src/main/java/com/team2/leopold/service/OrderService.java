...
public class OrderService {
    ...
    public ResponseOrderPageDto findOrder(Integer orderUid) throws EntityNotFoundException {
        ...
        Order foundOrder = optionalOrder.get();
        ResponseOrderDto orderDto = new ResponseOrderDto(foundOrder.getUid(), foundOrder.getDate(), foundOrder.getReceiver(), foundOrder.getReceiveMethod(), foundOrder.getZipcode(), foundOrder.getAddress(), foundOrder.getAddressDetail(), foundOrder.getPhone(), foundOrder.getMessage(), foundOrder.getDeliverPrice(), foundOrder.getStatus(), foundOrder.getFinalPrice(), foundOrder.getPaymentMethod(), foundOrder.getAccount(), foundOrder.getHolder(), foundOrder.getPoint());
        ...
        for (Wish w : wishList) {
            ResponseOrderedWishDto orderedWishDto = new ResponseOrderedWishDto(w.getUid(), w.getCart().getQuantity(), w.getPrice(), w.getDiscountRate(), w.getCart().getProduct().getProductCategory().getName(), w.getCart().getProduct().getColor(), w.getCart().getProduct().getEngraving(), w.getCart().getProduct().getSwitchValue(), w.getCart().getProduct().getCoverUrl(), w.getOrder().getStatus());
